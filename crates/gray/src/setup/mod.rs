...
pub use catalog::{
    AUTH_MODE_API_KEY, AUTH_MODE_NONE, AUTH_MODE_OAUTH, Catalog, CatalogProvider, ConnectItem,
    PROVIDERS_JSON, SavedConfig, build_connect_items, gray_home, load_auth_keys, load_catalog,
